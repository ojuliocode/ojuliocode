...
const extraLinks = [
  {
    title: "Black month da Rocketseat!",
    url: "https://rseat.in/blackmonth-ojuliocode",
    description: "5 anos de acesso à plataforma da Rocketseat ONE! Tudo isso com 67% de desconto",
